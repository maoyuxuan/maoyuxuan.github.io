    ...
    var PhotoBrowser = function (params) {
        ...
        var navbarTemplate = pb.params.navbarTemplate ||
                            '<header class="bar bar-nav">' +
                                '<div class="left"><a class="link ui-icon-navbar-left photo-browser-close-link back" href="javascript:;"></a></div>' +
                                '<div class="title"><span class="photo-browser-current"></span> <span class="photo-browser-of">' + pb.params.ofText + '</span> <span class="photo-browser-total"></span></div>' +
                                '<div class="right"></div>' +
                            '</header>';
        ...
        var photoTemplate = !pb.params.lazyLoading ?
            ...
            (pb.params.photoLazyTemplate || '<div class="photo-browser-slide photo-browser-slide-lazy swiper-slide"><div class="preloader preloader-white"></div><span class="photo-browser-zoom-container"><img data-src="{{url}}" class="swiper-lazy"></span></div>');

        var captionsTemplate = pb.params.captionsTemplate || '<div class="photo-browser-captions">{{captions}}</div>';
        ...
        pb.open = function (index) {
            ...
            if (pb.params.type === 'page') {
                ...
                $(document).on('beforePageRemove', pb.onPageBeforeRemove);
        ...
        pb.onPageBeforeRemove = function (e) {
            ...
            $(document).off('beforePageRemove', pb.onPageBeforeRemove);
        };
